...
public class Fragment_organizationList_myAdmin extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Lv_organization_admin.setOnItemClickListener(new Fragment_organizationList_myAdmin.MyOnItemClickListener());
