...
public class Activity_Register extends Activity_Base implements View.OnClickListener {
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == -9) {
                Btn_Register_Message.setText("重新发送(" + i + ")");
            } else if (msg.what == -8) {
                Btn_Register_Message.setText("获取验证码");
                Btn_Register_Message.setClickable(true);
            } else {
                int event = msg.arg1;
                int result = msg.arg2;
                Object data = msg.obj;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.Btn_Register_Message:
                // 1. 通过规则判断手机号
                ...
                i=30;
                Btn_Register_Message.setClickable(false);
                Btn_Register_Message.setText("重新发送(" + i-- + ")");
            ...
            case R.id.Btn_Register_Go:
                String message=ET_Register_Message.getText().toString();
